        ...
        <div className="px-5 flex flex-col lg:flex-row gap-4">
          <div className="basis-1/2">
            ...
            <div className=" flex gap-5 my-10">
              ...
              <button
                type="button"
                className="text-black  flex gap-3 align-middle bg-slate-100   font-medium rounded-lg text-sm px-10 py-2.5 mr-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                <span>
            ...
            <div className="w-3/4 flex justify-between items-center mt-10">
              <img src="../images/brand-one.png" alt="" />
              <img src="../images/brand-two.png" alt="" />
              <img src="../images/brand-three.png" alt="" />
              <img src="../images/brand-four.png" alt="" />
            </div>
          </div>
